...
for (tissue in keep_tissues) {
  ...
  #Check this out https://s3.amazonaws.com/assets.datacamp.com/production/course_6650/slides/chapter2.pdf
    ...
    #Check with normal tissue from different dataset
...
write.csv(cumulative_results_ROC_PR,file="./8Tissues_CssOnly_GTEX_results_Filter10percent_Agamemnon_LiivingProject.csv")
