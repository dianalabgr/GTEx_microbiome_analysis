...
def counts2lineage(accession_Readcounts, taxid_Accessions, lineage):
	...
	for i in range(0, len(accession_Readcounts_notZero)):
		for key in taxid_Accessions:
			if accession_Readcounts_notZero[i][0] in taxid_Accessions[key]:
				if key in taxid_Readcounts:
					taxid_Readcounts[key] += accession_Readcounts_notZero[i][1]
				else:
					taxid_Readcounts[key] = accession_Readcounts_notZero[i][1]
